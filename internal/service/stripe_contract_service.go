...
func (rs *ResponsibleService) GetDistance(origin, destination string) (*float64, error) {
...
func (rs *ResponsibleService) CalculateContractValue(distance, amount float64) float64 {
...
func (rs *ResponsibleService) CreateProduct(contract *models.Contract) (*stripe.Product, error) {
...
func (rs *ResponsibleService) CreatePrice(contract *models.Contract) (*stripe.Price, error) {
...
func (rs *ResponsibleService) CreateSubscription(contract *models.Contract) (*stripe.Subscription, error) {
...
func (rs *ResponsibleService) CalculateRemainingValueSubscription(invoices []models.InvoiceInfo) *models.InvoiceRemaining {
